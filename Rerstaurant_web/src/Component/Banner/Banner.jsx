  ...
  return (
    <>
      <div className="container py-14 relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 py-10">
              <div>
                <p>
                  ...
                  who want to eat healthify, saving time for buying food and
                  preapring delicious healthy meals.
                </p>
              </div>
              <div></div>
            </div>
        ...
        <div
          data-aos="fade"
          className="absolute top-1/2 translate-y-1 left-1/3 -translate-x-6"
        >
