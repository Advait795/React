      ...
      <div className="container min-h-[620px] flex">
        <div className="grid place-items-center grid-cols-1 sm:grid-cols-2">
          ...
          <div className="order-2 sm:order-1 space-y-5 sm:pr-32">
            <p data-aos="fade-up" className="text-primary font-serif">
              Effortless
            </p>
            <h1
              data-aos="fade-up"
            ...
            <button
              data-aos="fade-up"
              data-aos-delay="1100"
              className="btn bg-primary text-black font-semibold font-serif px-6 py-2 rounded-md hover:bg-primary/80 duration-300"
            >
              Get Started
            </button>
          </div>
